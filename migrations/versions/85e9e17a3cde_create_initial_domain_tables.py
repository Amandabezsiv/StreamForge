...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_video_outputs_video_id'), 'video_outputs', ['video_id'], unique=False)
    ...
    op.create_index(op.f('ix_processing_events_video_id'), 'processing_events', ['video_id'], unique=False)
